...
<link rel="stylesheet" href="${ctx}/lib/layui-v2.7.6/layui/css/layui.css" media="all">
...
<script src="${ctx}/lib/layui-v2.7.6/layui/layui.js" type="text/javascript" charset="utf-8"></script>
