        ...
        <div class="layui-side-scroll layui-left-menu">
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-5" data-tab="user/status" target="_self"><i class="fa fa-tachometer"></i><span class="layui-left-nav"> 个人状态</span></a>
                                    </dd>
                                    <dd>
